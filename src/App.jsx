    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: c.bg, minHeight: "100vh", color: c.text, transition: "background 0.3s, color 0.3s", display: "flex", flexDirection: "column" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Custom input row stacks on mobile */
        .custom-input-row { display: flex; gap: 8px; flex-direction: row; }
        .custom-input-row input { flex: 1; }
        .custom-input-row button { flex-shrink: 0; }
        ...
        @media (max-width: 600px) {
          ...
          /* Custom path input: button drops below, both full width */
          .custom-input-row { flex-direction: column; }
          .custom-input-row input { width: 100%; }
      ...
      <div style={{ maxWidth: 720, width: "100%", margin: "0 auto", padding: "0 28px", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <header style={{ padding: "40px 0 20px", borderBottom: `1px solid ${c.border}`, marginBottom: 36 }}>
          ...
          <div className="header-icons-mobile" style={{ display: "flex", justifyContent: "flex-end", marginBottom: 10 }}>
              ...
              <div style={{ marginBottom: 36 }}>
                ...
                <div style={{ marginTop: 10 }}>
                  <button onClick={() => { setUserName(""); setNameSubmitted(true); }} style={{ background: "none", border: "none", color: c.textFaint, fontSize: "0.75rem", textDecoration: "underline", textUnderlineOffset: 3, cursor: "pointer", padding: 0 }}>
                    Skip — just take me to the dreams
                  </button>
                </div>
              </div>
            ) : (
              <>
                ...
                {userName && (
                  <div style={{ marginBottom: 32 }}>
                    ...
                    <div style={{ fontSize: "0.88rem", color: c.textMuted, marginTop: 8 }}>Pick a dream or type your own. No sugarcoating.</div>
                  </div>
                )}

                {/* Custom path — prominent, at top */}
                <div style={{ marginBottom: 28 }}>
                  <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "0.95rem", color: c.text, marginBottom: 6 }}>Type your own dream</div>
                  <div style={{ fontSize: "0.78rem", color: c.textMuted, marginBottom: 12 }}>Any career, lifestyle, or challenge — we'll build the questions around your dream.</div>
